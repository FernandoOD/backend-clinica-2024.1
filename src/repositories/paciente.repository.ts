...
import {Consulta, EjercicioPractico, EvaluacionProgreso, HistoriaClinica, Mensaje, ModuloPsicoeducativo, NotaClinica, Paciente, PacienteEjercicioPractico, PacienteModuloPsicoeducativo, PacienteRelations, PacienteTerapeuta, Terapeuta} from '../models';
...
> {
  ...
  public readonly notasClinicas: HasManyRepositoryFactory<NotaClinica, typeof Paciente.prototype.id>;
  ...
  constructor(
    ...
    this.notasClinicas = this.createHasManyRepositoryFactoryFor('notasClinicas', notaClinicaRepositoryGetter,);
    this.registerInclusionResolver('notasCliicas', this.notasClinicas.inclusionResolver);
